...
export class PeriodicidadService {
    ...
    private _getTiempoPeriodicidad() {
        //configurar headers 
        ...
        //consumo de api
        return this._http.get(`${this._urlBase}tareas/tiempo/periodicidad/${this._user}`, { headers: headers });
    }

    //funcion asyncrona con promesa
    getTiempoPeriodicidad(): Promise<ResApiInterface> {
        return new Promise((resolve, reject) => {
            this._getTiempoPeriodicidad().subscribe(
