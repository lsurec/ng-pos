...
export class ResumenDocumentoComponent implements OnInit {
  ...
  async sendDocument() {
    ...
    let doc: Documento = {
      ...
      Doc_Tipo_Referencia: this.facturaService.valueParametro(85) ? this.facturaService.tipoReferencia?.tipo_Referencia : null,
      Doc_Fecha_Entrega: this.facturaService.valueParametro(381) ? this.facturaService.fechaEntrega : null,
      Doc_Fecha_Recoger: this.facturaService.valueParametro(382) ? this.facturaService.fechaRecoger : null,
      Doc_Fecha_Incio: this.facturaService.valueParametro(44) ? this.facturaService.fechaIni : null,
      Doc_Fecha_Finalizacion: this.facturaService.valueParametro(44) ? this.facturaService.fechaFin : null,
      Doc_Ref_Contacto: this.facturaService.valueParametro(385) ? this.facturaService.refContacto : null,
      Doc_Ref_Descripcion: this.facturaService.valueParametro(383) ? this.facturaService.refDescripcion : null,
      Doc_Ref_Direccion_Entrega: this.facturaService.valueParametro(386) ? this.facturaService.refDireccionEntrega : null,
