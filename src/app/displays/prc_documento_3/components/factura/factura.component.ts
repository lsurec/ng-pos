...
export class FacturaComponent implements OnInit {
  ...
  replaceValuesJson(param: string, document: DocXMLInterface, credenciales: CredencialInterface[],) {
    ...
    subs.forEach(i => {
      ...
      subs2[1] = subs2[1].replace('{xml_Contenido}', `<dte:GTDocumento xmlns:dte="http://www.sat.gob.gt/dte/fel/0.2.0" Version="0.1">
  <dte:SAT ClaseDocumento="dte">
    <dte:DTE ID="DatosCertificados">
      <dte:DatosEmision ID="DatosEmision">
        <dte:DatosGenerales CodigoMoneda="GTQ" FechaHoraEmision="2024-07-23T02:53:51.000-06:00" Tipo="FCAM" />
