...
import { Documento } from 'src/app/displays/prc_documento_3/interfaces/doc-estructura.interface';
import { DocumentoResumenInterface } from 'src/app/displays/prc_documento_3/interfaces/documento-resumen.interface';
import { GetDocInterface } from 'src/app/displays/prc_documento_3/interfaces/get-doc.interface';
...
@Component({
  selector: 'app-docs-historial',
  templateUrl: './docs-historial.component.html',
  styleUrls: ['./docs-historial.component.scss'],
  providers: [
    DocumentService,
    TipoTransaccionService,
  ]
})
export class DocsHistorialComponent implements OnInit {
